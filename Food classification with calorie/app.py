    ...
    st.markdown(
        ...
        <style>
            body {
                ...
                font-family: 'Times New Roman', Times, serif !important;  /* Times New Roman font */
            }
            .css-hi6a2p h1 {
...
def run():
    set_custom_style()
    st.title("Food Image Classifier and Calorie Calculator")
    st.markdown("Upload an image of your food, and let me classify it for you!")
